        ...
        <div className="text-center">
          ...
          <form className="flex flex-wrap gap-3 max-w-lg mx-auto mb-4">
            ...
            <button
              ...
              className="px-10 py-3 bg-linear-to-r from-orange-500 to-red-500 text-white font-semibold rounded-lg hover:from-orange-600 hover:to-red-600 transition-all duration-200 shadow-lg hover:shadow-xl flex-1"
            >
              Get Started
            </button>
          </form>
